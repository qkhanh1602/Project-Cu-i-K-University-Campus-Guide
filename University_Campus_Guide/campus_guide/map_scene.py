...
from algorithmsUI.game_common import advance_opponents, fixed_opponent_starts, opponent_positions_for_route
...
class CampusMapView(QGraphicsView):
    ...
    def _draw_stage6_constraint_markers(self) -> None:
        from algorithmsUI.csp_common import _csp_domains
    ...
    def _draw_belief_paths(self, paths: Optional[Sequence[Sequence[GridPos]]]) -> None:
        ...
        for index, path in enumerate(paths or []):
            ...
            for cell in path:
                ...
                marker.setToolTip(f"Nganh duong {index + 1}")
    ...
    def set_trace_overlay(
        ...
        if csp_mode and csp_color_cells:
            from algorithmsUI.csp_common import csp_building_for_pos
